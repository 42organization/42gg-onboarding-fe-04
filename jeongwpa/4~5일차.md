...
- [ ] 코드 컨벤션 숙지하기 [[참고]](https://www.notion.so/c0425406535c47df89714df16b585f19?pvs=4)
- [ ] API 명세서 작성
- [ ] API 명세서는 사진(`.jpg` 혹은 `.png`)으로 제출
...
|  `GET`  | `/students/{student_id}`         | 학생 정보       | `200 OK`      |
|  `GET`  | `/students/{student_id}/current` | 재학생 목록      | `200 OK`      |
| `PATCH` | `/students/{student_id}/drop`    | 학생 휴학       | `200 OK`      |
|  `GET`  | `/students/{student_id}/finish`  | 학생 졸업       | `200 OK`      |
